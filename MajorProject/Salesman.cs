...
namespace DPerevalov.SoftWareDeveloped.MajorProject
{
    public class Salesman
    {
        ...
        public static decimal WagesSalesman(string sDate, string tDate, string salaryRate)
        {
            decimal wagesSalesman = 0.0M;
            int percent = 1, rData;
            ...
            //Вычисляем зарплату
            wagesSalesman = ((dSalaryRate + (dSalaryRate / 100 * percent)) / dayEndMonth) * dayEnd;

            return wagesSalesman;
        }
    }
}
